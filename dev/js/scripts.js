...
function TL(){
    ...
    tl.to("#thin-frosting-1", {duration:3, delay:4, motionPath:{path:"#thin-frosting-motion-path-1", align:"#thin-frosting-motion-path-1", alignOrigin:[0.5, 0], autoRotate:-80}, ease:"none"}, "fall-tilt"); 
    tl.to("#thin-frosting-2", {duration:3, delay:4.6, motionPath:{path:"#thin-frosting-motion-path-2", align:"#thin-frosting-motion-path-2", alignOrigin:[0.5, 0], autoRotate:-80}, ease:"none"}, "fall-tilt"); 
    ...
    tl.to("#thin-frosting-4", {duration:3, delay:6.9, motionPath:{path:"#thin-frosting-motion-path-4", align:"#thin-frosting-motion-path-4", alignOrigin:[0.5, 0.6], autoRotate:80}, ease:"none"}, "fall-tilt");  
    return tl;
}
