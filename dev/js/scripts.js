...
function TL(){
    ...
    // tl.to("#thin-frosting-1", {duration:2.5, delay:9, motionPath:{path:"#thin-frosting-motion-path-1-2", align:"#thin-frosting-motion-path-1-2", alignOrigin:[0.5, 0.5], autoRotate:-100}, ease:"none"}, "fall-tilt");
    // tl.to("#thin-frosting-2", {duration:2.5, delay:9, motionPath:{path:"#thin-frosting-motion-path-2-2", align:"#thin-frosting-motion-path-2-2", alignOrigin:[0.5, 0.5], autoRotate:-100}, ease:"none"}, "fall-tilt"); 
    // tl.to("#thin-frosting-3", {duration:2.5, delay:9, motionPath:{path:"#thin-frosting-motion-path-3-2", align:"#thin-frosting-motion-path-3-2", alignOrigin:[0.5, 0.5], autoRotate:100}, ease:"none"}, "fall-tilt");
    // tl.to("#thin-frosting-4", {duration:2.5, delay:9, motionPath:{path:"#thin-frosting-motion-path-4-2", align:"#thin-frosting-motion-path-4-2", alignOrigin:[0.5, 0.5], autoRotate:100}, ease:"none"}, "fall-tilt");
    return tl;
}
